...
const Nav = () => {
  return (
    <> 
       <div className="z-20">
        <div className="absolute inset-0 bg-cover bg-center bg-gradient-to-b from-100% to-10% opacity-20" style={{backgroundImage: `url(${netflix_login_background})`}}>
        </div>
            <div className='relative z-10'>
                <div className="flex justify-between items-center">
                <div id='navTitle' className="text-3xl font-bold text-red-600">
                 NETFLIX CLONED!
                </div>
                <div className="flex">
                    <div>
                        <select id="language" className="text-xs pr-10 border p-1 mr-2 border-gray-500 rounded">
                            <option className="text-black" value="English">English</option>
                            <option className="text-black" value="Spanish">Spanish</option>
                        </select>
                    </div>
                  <button id='signIn' className="text-xs bg-red-600 px-5 py-1 rounded">Sign In</button>
                </div>
            </div>
            ...
            <div id='navSubscribe' className="m-4 flex items-center">
